    ...
    <div>
      ...
      <div className="flex">
        <div className="w-screen flex-col mx-2 py-2 px-2 grid grid-cols-2 gap-1 xl:grid-cols-4 md:gap-2">
          {/* private presale */}
          <div className="bg-red-400 rounded-md text-white  px-2 py-3">
          ...
          {/* initial presale */}
          <div className="bg-amber-300 rounded-md text-white  px-2 py-3">
            <div className="  text-md md:text-2xl font-bold mt-2 flex justify-between">
          ...
          {/* sale package */}
          <div className="bg-lime-400 rounded-md text-white  px-2 py-3">
            <div className="  text-md md:text-2xl font-bold mt-2 flex justify-between">
          ...
          {/* liquidity pool */}
          <div className="bg-green-300 rounded-md text-white  px-2 py-3">
            <div className="  text-md md:text-2xl font-bold mt-2 flex justify-between">
          ...
          {/* Pioneer fc */}
          <div className="bg-blue-600 rounded-md text-white  px-2 py-3">
            <div className="  text-md md:text-2xl font-bold mt-2 flex justify-between">
              <span> Pool</span>
              <h1>
                <FaChartArea />
          ...
          {/* presale balance */}
          <div className="bg-violet-500 rounded-md text-white  px-2 py-3">
            <div className="  text-md md:text-2xl font-bold mt-2 flex justify-between">
          ...
          {/* total supply*/}
          <div className="bg-pink-700 rounded-md text-white  px-2 py-3">
            <div className="  text-md md:text-2xl font-bold mt-2 flex justify-between">
              <span>Liquidity Pool</span>
              <h1>
                <GiFilmSpool />
