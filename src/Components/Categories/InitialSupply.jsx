  ...
  return (
    ...
    <div className="flex">
      <div className="w-screen flex-col mx-2 py-2 px-2 grid grid-cols-2 gap-1 xl:grid-cols-4 md:gap-2">
        {/* private presale */}
        <div className="bg-pink-900 rounded-md text-white  px-2 py-3">
        ...
        {/* initial presale */}
        <div className="bg-slate-300 rounded-md text-white  px-2 py-3">
          <div className="  text-md md:text-2xl font-bold mt-2 flex justify-between">
        ...
        {/* sale package */}
        <div className="bg-orange-500 rounded-md text-white  px-2 py-3">
          <div className="  text-md md:text-2xl font-bold mt-2 flex justify-between">
        ...
        {/* liquidity pool */}
        <div className="bg-gray-700 rounded-md text-white  px-2 py-3">
          <div className="  text-md md:text-2xl font-bold mt-2 flex justify-between">
        ...
        {/* Staking pool */}
        <div className="bg-teal-400 rounded-md text-white  px-2 py-3">
          <div className="  text-md md:text-2xl font-bold mt-2 flex justify-between">
        ...
        {/* Pioneer fc */}
        <div className="bg-orange-900 rounded-md text-white  px-2 py-3">
          <div className="  text-md md:text-2xl font-bold mt-2 flex justify-between">
            <span> Pool</span>
            <h1>
              <FaChartArea />
        ...
        {/* presale balance */}
        <div className="bg-cyan-700 rounded-md text-white  px-2 py-3">
          <div className="  text-md md:text-2xl font-bold mt-2 flex justify-between">
        ...
        {/* total supply*/}
        <div className="bg-purple-700 rounded-md text-white  px-2 py-3">
          <div className="  text-md md:text-2xl font-bold mt-2 flex justify-between">
            <span>Liquidity Pool</span>
            <h1>
              <GiFilmSpool />
